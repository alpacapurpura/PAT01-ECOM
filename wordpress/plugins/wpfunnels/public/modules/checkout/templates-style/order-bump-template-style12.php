...
<div class="wpfnl-reset wpfnl-order-bump__template-style12" style="background-color: <?php echo $orderbump_bgcolor; ?>">
    ...
    <div class="template-preview-wrapper">
        ...
        <div class="template-content">
            ...
            <div class="description" id="wpfnl-order-bump-description-<?php echo $key; ?>" style="color: <?php echo $ob_description_color ?>; --descColor12:<?php echo $ob_description_color ?>" ><?php echo $settings['productDescriptionText'] ?></div>
            <span class="product-price" id="wpfnl-order-bump-price-<?php echo $key; ?>" style="--priceColor12: <?php echo $orderbump_priceColor ?> ">
