...
<div class="wpfnl-reset wpfnl-order-bump__template-style2 <?php echo $key.'-wpfnl-order-bump';?>" style="background-color: <?php echo $orderbump_bgcolor; ?>">
    ...
    <div class="offer-checkbox" style="background-color: <?php echo $orderbump_color; ?>">
        ...
        <span class="product-price" id="wpfnl-order-bump-price-<?php echo $key; ?>" style="--priceColor2: <?php echo $orderbump_priceColor ?> ">
            <?php echo $price; ?>
        </span>
    </div>
    <?php
    ...
    <div class="template-preview-wrapper">
        ...
        <div class="template-content">
            ...
            <div class="description" id="wpfnl-order-bump-description-<?php echo $key; ?>" style="color: <?php echo $ob_description_color ?>; --descColor2:<?php echo $ob_description_color ?>" ><?php echo $settings['productDescriptionText'] ?></div>
            <?php if ($isVariable): ?>
