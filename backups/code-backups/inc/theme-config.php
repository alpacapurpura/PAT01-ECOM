<?php if(!function_exists('organify_configs')){
    function organify_configs($value){
        $primary_darker = organify()->get_opt('primary_color', '#4B0082');
        ...
        $configs = [
            'theme_colors' => [
                'primary'   => [
                    ...
                    'value' => organify()->get_opt('primary_color', '#222222')
                ],
                'gradient-first'   => [
                    'title' => esc_html__('Gradient First', 'organify'), 
                    'value' => organify()->get_opt('gradient_first_color', '#D2691E')
                ],
                'secondary'   => [
                ...
                'third'   => [
                    ...
                    'value' => organify()->get_opt('third_color', '#C72C48')
                ],
                'dark'   => [
                ...
                'body-bg'   => [
                    ...
                    'value' => organify()->get_page_opt('body_bg_color', '#fef6ff')
                ],
                'primary-darker-10'   => [
            ...
            'link' => [
                'color' => organify()->get_opt('link_color', ['regular' => '#2e8b57'])['regular'],
                'color-hover'   => organify()->get_opt('link_color', ['hover' => '#3CB371'])['hover'],
                'color-active'  => organify()->get_opt('link_color', ['active' => '#246B45'])['active'],
            ],
            'gradient' => [
                'color-from' => organify()->get_opt('gradient_color', ['from' => '#FFD700'])['from'],
                'color-to' => organify()->get_opt('gradient_color', ['to' => '#B8860B'])['to'],
            ],
            'gradient2' => [
